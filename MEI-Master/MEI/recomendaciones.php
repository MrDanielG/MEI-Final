        ...
        <div class="container">
            ...
            <div class="tap-target" data-activates="republicaCB">
              <div class="tap-target-content">
                <h5>Rango</h5>
                <p>Puedes filtrar las carreras pos la distancia entre tú y las universidades haciendo click en la palomita.</p>
              </div>
            </div>
        ...
        <script>
            ...
            $("#republicaCB").click(e=>{
              if(e.target.checked){
                ...
                $.ajax({url:"ajax/ajaxReco.php?range="+$(e.target).parent().find("#rangeReco")[0].valueAsNumber+"&lat="+pos.lat+"&lng="+pos.lng,
                        success: function(data){
                          $("#recoContainer").html(data);
                        }});
